...
/**
 * Susunan "usulan" halaman Card: satu bagian untuk tiap properti, dengan daftar
 * isi di kanan memakai nama propnya. Playground, Penggunaan, dan tabel
 * Properties ditaruh di akhir sebagai rangkuman.
 */
...
export function CardUsulanPage() {
  ...
  return (
    ...
    >
      <FlowSection id="image" title="image · imageAlt">
        <Lead>
          <C>image</C> berisi URL gambar yang mengisi bagian atas kartu; rasionya mengikuti lebar kartu —
          16:9 di kolom lebar, 5:4 di bawah 320px. <C>imageAlt</C> jadi teks alternatifnya, dan boleh string
          kosong bila gambarnya murni dekoratif. Tanpa <C>image</C>, kartu langsung dimulai dari judul.
        </Lead>
      ...
      <FlowSection id="title" title="title · description">
        <Lead>
          Dua-duanya <C>ReactNode</C>, jadi boleh disisipi elemen. Ukuran judul mengikuti lebar kartu: 20px
          di kolom lebar, turun ke 16px di kolom sempit. Deskripsi bersifat opsional — kartu dengan judul
          saja tetap rapi karena jaraknya diatur per bagian, bukan lewat margin tetap.
        </Lead>
        <Demo>
          <Column>
            <Card
      ...
      <FlowSection id="href" title="href · linkLabel">
        <Lead>
          Mengisi <C>href</C> mengubah bagian bawah kartu jadi satu tautan, bukan deretan tombol.{" "}
          <C>linkLabel</C> menentukan teksnya dan berlaku hanya bersama <C>href</C>; bila dikosongkan,
          teksnya jatuh ke bawaan <C>Selengkapnya</C>.
        </Lead>
        <Demo>
          <Column>
            <Card
      ...
      <FlowSection id="actions" title="actions">
        <Lead>
          Slot bebas di bagian bawah kartu — isi satu tombol, dua tombol, atau elemen lain. Card tidak
          mengatur ukuran maupun varian tombolnya, jadi keputusan itu tetap di tangan halaman yang
          memakainya. Bila kosong, bagian bawah kartu ditiadakan.
        </Lead>
        <div className="grid gap-5 sm:grid-cols-2">
      ...
      <FlowSection id="lebar" title="Lebar kartu">
        <Lead>
          Card sengaja tidak punya prop ukuran dan tidak diberi lebar bawaan — lebarnya urusan tata letak.
          Empat kartu di bawah ini ditulis dengan props yang sama persis; yang berbeda hanya lebar kolomnya,
          dan kartu menyesuaikan diri lewat <em>container query</em>: di bawah 320px gambarnya jadi 5:4,
          padding menyusut ke 16px, judul turun ke 16px; di atasnya gambar 16:9, padding 24px, judul 20px.
        </Lead>
        ...
        <p className="mt-3 text-body-sm text-gray-500">
          Di halaman formulir kartu perlu selebar kolomnya (lihat halaman <em>Example</em>), sementara di
          daftar ringkas ia perlu menyempit mengikuti grid. Menentukan lebar adalah tugas tata letak, bukan
          tugas kartu.
        </p>
      </FlowSection>
      ...
      <FlowSection id="properties" title="Properties">
        <Lead>
          Rangkuman seluruh prop. Semuanya opsional — bagian yang tidak diisi tidak dirender, bukan
      ...
      <FlowSection id="playground" title="Playground">
        <Lead>
          Menggabungkan prop-prop di atas dalam satu tampilan. Ganti kontrolnya, dan bagian Penggunaan
          menuliskan kodenya.
        </Lead>
      ...
      <FlowSection id="penggunaan" title="Penggunaan">
        <Lead>
          Mengikuti kontrol di Playground — nama prop yang sedang dikendalikan ditandai dengan warna biru.
          Tombol <em>Salin</em> selalu menyalin persis yang sedang tampil.
        </Lead>
        <SectionCode flush>
          {"import { Card"}
          {withButton && ", Button"}
