...
export function SelectUsulanPage() {
    ...
    >
      ...
      <FlowSection id="state" title="State">
        ...
        <SectionCode>
          {'<Select '}
          <H>state</H>
          {'="inactive" label="Label" placeholder="Pilih Apapun Itu" options={provinsi} />'}
        </SectionCode>
      </FlowSection>
      ...
      <FlowSection id="playground" title="Playground">
        ...
        <Stage maxWidth={narrow ? 'max-w-[340px]' : 'max-w-[348px]'}>
          <Select
            ...
            placeholder="Pilih Apapun Itu"
            options={provinsi}
            helperText={withHelper ? 'Pilih salah satu provinsi.' : undefined}
            value={value}
        ...
        <SectionCode flush>
          ...
          {withInfo && (
            <>
              {'    '}
              <H>info</H>
              {'="Keterangan singkat tentang isian ini."\n'}
            </>
          )}
          {'    placeholder="Pilih Apapun Itu"\n'}
          {'    options={provinsi}\n'}
