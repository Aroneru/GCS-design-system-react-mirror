...
export function FoundationsOverview() {
  return (
    <OverviewPage
      ...
      title="Foundations"
      description="Token dan aturan dasar yang menjadi pijakan seluruh komponen: warna, tipografi, jarak, garis, kedalaman, dan ikon. Semuanya terbit sebagai CSS token lewat @ceplok-ui/design-kit-react/tokens.css."
    >
      <OverviewCard
