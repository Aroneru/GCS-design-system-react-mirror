...
const accents: Record<CheckboxApplication, string> = {
  ...
  portal: 'checked:border-blue-portal-500 checked:bg-blue-portal-500 focus-visible:outline-blue-portal-500',
    ...
    >
      <input
        ...
        className={cn(
          ...
          isInactive ? 'checked:border-gray-400 checked:bg-gray-400' : cn('cursor-pointer', accents[application]),
        )}
        {...props}
      />
